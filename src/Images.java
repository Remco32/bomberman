...
public class Images {
    ...
    Images(){
        try {
            ...
            wallSoft = buffer.getScaledInstance(50, 50, Image.SCALE_DEFAULT);
            buffer = ImageIO.read(getClass().getResource("concrete.jpg"));
            wallHard = buffer.getScaledInstance(50, 50, Image.SCALE_DEFAULT);
            ...
            player2 = buffer.getScaledInstance(40, 40, Image.SCALE_DEFAULT);
            buffer = ImageIO.read(getClass().getResource("bomberman3.png"));
            player3 = buffer.getScaledInstance(40, 40, Image.SCALE_DEFAULT);
            buffer = ImageIO.read(getClass().getResource("bomberman4.png"));
            player4 = buffer.getScaledInstance(40, 40, Image.SCALE_DEFAULT);
